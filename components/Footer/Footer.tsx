...
export default () => {
    return <footer style={{ display: 'flex', flexDirection: 'row-reverse', float: 'right', paddingTop: 40
        ...
        <div style={{ backgroundColor: colors.overlay, padding: 5, display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', width: '100%' }}>
            <StyledNavItem href='/terms-conditions'>Terms</StyledNavItem>
            <StyledNavItem href='/privacy-policy'>Privacy</StyledNavItem>
        </div>
        <style jsx>
            {`
            .footer-logo-section {
